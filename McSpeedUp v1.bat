...
:mainmenu
echo Welcome to McSpeedUp!
echo.
echo Type help for see the commands.
echo.
set/p option=
...
if /i "%option%"=="cls" (cls & goto :mainmenu)

echo Sorry, but the command %option% isn't valid. 
echo Type help for see the commands.
...
echo.     ▀▀▀▀▀▀▀ ▀▀ ▀▀   ▀▀▀  ▀  ▀
timeout /t 1 >nul
if %error_percentage% geq 100 (%error-cmd%)
goto error
